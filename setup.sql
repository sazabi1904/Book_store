...
-- Thêm Sách
INSERT INTO books (id, title, author, category, year, quantity) 
VALUES ('B001', 'Lập trình Java', 'James Gosling', 'Công nghệ thông tin', 2020, 10),
       ('B002', 'Cấu trúc dữ liệu và giải thuật', 'Nguyễn Văn C', 'Giáo trình', 2018, 5),
       ('B003', 'Sách Đắc Nhân Tâm', 'Dale Carnegie', 'Tâm lý', 1936, 15),
       ('B004', 'One Piece Vol.1', 'Eiichiro Oda', 'Manga', 1997, 20),
        ('B005', 'Naruto Vol.1', 'Masashi Kishimoto', 'Manga', 1999, 18),
        ('B006', 'Attack on Titan Vol.1', 'Hajime Isayama', 'Manga', 2009, 15),
        ('B007', 'Death Note Vol.1', 'Tsugumi Ohba', 'Manga', 2003, 12),
        ('B008', 'Dragon Ball Vol.1', 'Akira Toriyama', 'Manga', 1984, 14),
        ('B009', 'Doraemon Vol.1', 'Fujiko F. Fujio', 'Manga', 1969, 25),
        ('B010', 'Tokyo Revengers Vol.1', 'Ken Wakui', 'Manga', 2017, 10),
        ('B011', 'Jujutsu Kaisen Vol.1', 'Gege Akutami', 'Manga', 2018, 16),
        ('B012', 'Batman: Year One', 'Frank Miller', 'Comic', 1987, 8),
        ('B013', 'Spider-Man: Blue', 'Jeph Loeb', 'Comic', 2002, 7),
        ('B014', 'The Avengers Vol.1', 'Stan Lee', 'Comic', 1963, 9),
        ('B015', 'Watchmen', 'Alan Moore', 'Comic', 1986, 6),
        ('B016', 'Solo Leveling Vol.1', 'Chugong', 'Manhwa', 2018, 20),
        ('B017', 'Tower of God Vol.1', 'SIU', 'Manhwa', 2010, 12),
        ('B018', 'The Beginning After The End Vol.1', 'TurtleMe', 'Manhwa', 2018, 11);
